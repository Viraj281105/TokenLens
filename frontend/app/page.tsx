...
export default function DashboardPage() {
  return (
    <div className="min-h-screen bg-background">
      {/* ── Header ──────────────────────────────────────────────── */}
      <header className="border-b border-blue-500/10 bg-zinc-950/50 backdrop-blur-xl sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="relative">
              <div className="w-9 h-9 rounded-xl bg-gradient-to-r from-blue-500 to-purple-500 flex items-center justify-center shadow-lg animate-pulse-glow">
                <Layers className="w-5 h-5 text-white" aria-hidden="true" />
              </div>
            </div>
            <div>
              <h1 className="text-lg font-bold tracking-tight gradient-text-blue-purple">
                TokenLens
              </h1>
          ...
          <nav className="flex items-center gap-3" aria-label="Header navigation">
            <a
              href="/docs"
              className="text-xs text-zinc-400 hover:text-blue-400 transition-colors focus-ring px-3 py-1.5 rounded-lg"
      ...
      <main id="main-content" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
          ...
          {[
            ...
            return (
              ...
              >
                ...
                {i < arr.length - 1 && (
                  <div className="hidden md:block absolute top-1/2 -right-4 w-4 h-0.5 bg-zinc-700 z-0"></div>
                )}
                ...
                <span className="absolute -top-2 -left-2 w-5 h-5 rounded-full bg-zinc-900 border text-[10px] font-bold flex items-center justify-center text-zinc-300"
                  style={{ borderColor: `${layer.colorCode}40` }}
                >
                  {i + 1}
                </span>
              </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-5 gap-6 animate-page-load" style={{ animationDelay: '0.2s' }}>
        ...
        {/* Security badge */}
        <section className="glass-card p-4 flex items-center gap-3 text-sm text-zinc-400 animate-page-load" style={{ animationDelay: '0.3s' }} aria-label="Security information">
